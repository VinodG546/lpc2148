...
// I2C Initialization
void i2c_init(void) {
    PINSEL0 |= 0x50;       // P0.2 = SCL0 (function 1), P0.3 = SDA0 (function 1)
    I2C0CONCLR = 0x6C;     // Clear all bits: AA, SI, STO, STA, I2EN
    I2C0SCLL = 0x32;       // Low duty cycle
    I2C0SCLH = 0x32;       // High duty cycle
    I2C0CONSET = 0x40;     // Enable I2C (I2EN)
}
